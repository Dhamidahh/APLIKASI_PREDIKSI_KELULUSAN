...
if (selected == 'SEMESTER 1'):
    ...
    if st.button('Klasifikasi Kelulusan'):
        ...
        if SEMESTER_1_prediction[0] == 0:
            SEMESTER_1_PREDICTION = 'KAMU DIKlasifikasi LULUS TIDAK TEPAT WAKTU!'
            MOTIVASI = (
            ...
            SEMESTER_1_PREDICTION = 'SELAMAT KAMU DIKlasifikasi LULUS TEPAT WAKTU!'
            MOTIVASI = (
...
if (selected == 'SEMESTER 2'):
    ...
    if st.button('Klasifikasi Kelulusan'):
        ...
        if SEMESTER_2_prediction[0] == 1:
            SEMESTER_2_PREDICTION = 'KAMU DIKlasifikasi LULUS TIDAK TEPAT WAKTU!'
            MOTIVASI = (
            ...
            SEMESTER_2_PREDICTION = 'SELAMAT KAMU DIKlasifikasi LULUS TEPAT WAKTU!'
            MOTIVASI = (
                ' Kamu telah melalui lebih dari 20 sks dengan baik. Pertahankan dan tingkatkan kembali nilai-nilai di semester kedepan. '
...
if (selected == 'SEMESTER 3'):
    ...
    if st.button('Klasifikasi Kelulusan'):
        ...
        if SEMESTER_3_prediction[0] == 0:
            SEMESTER_3_PREDICTION = 'KAMU DIKlasifikasi LULUS TIDAK TEPAT WAKTU!'
            MOTIVASI = (
                ' Jangan patah semangat, terus perbaiki nilaimu. '
            ...
            SEMESTER_3_PREDICTION = 'SELAMAT KAMU DIKlasifikasi LULUS TEPAT WAKTU!'
            MOTIVASI = (
                ' Kamu telah melalui lebih dari 20 sks dengan baik. Pertahankan dan tingkatkan kembali nilai-nilai di semester kedepan. '
...
if (selected == 'SEMESTER 4'):
    ...
    if st.button('Klasifikasi Kelulusan'):
        ...
        if SEMESTER_4_prediction[0] == 0:
            SEMESTER_4_PREDICTION = 'KAMU DIKlasifikasi LULUS TIDAK TEPAT WAKTU!'
            MOTIVASI = (
                ' Jangan patah semangat, terus perbaiki nilaimu.')
            img3 = Image.open('SYARAT NILAI.jpg')
            st.image(img3, use_column_width=True) 
            ...
            SEMESTER_4_PREDICTION = 'SELAMAT KAMU DIKlasifikasi LULUS TEPAT WAKTU!'
            MOTIVASI = (
                ' Kamu telah melalui lebih dari 20 sks dengan baik. Pertahankan dan tingkatkan kembali nilai-nilai di semester kedepan. '
...
if (selected == 'SEMESTER 5'):
    ...
    if st.button('Klasifikasi Kelulusan'):
        ...
        if SEMESTER_5_prediction[0] == 0:
            SEMESTER_5_PREDICTION = 'KAMU DIKlasifikasi LULUS TIDAK TEPAT WAKTU!'
            MOTIVASI = (
            ...
            SEMESTER_5_PREDICTION = 'SELAMAT KAMU DIKlasifikasi LULUS TEPAT WAKTU!'
            MOTIVASI = (
                ' Kamu telah melalui lebih dari 20 sks dengan baik. Pertahankan dan tingkatkan kembali nilai-nilai di semester kedepan. '
...
if (selected == 'SEMESTER 6'):
    ...
    if st.button('Klasifikasi Kelulusan'):
        ...
        if SEMESTER_6_prediction[0] == 0:
            SEMESTER_6_PREDICTION = 'KAMU DIKlasifikasi LULUS TIDAK TEPAT WAKTU!'
            MOTIVASI = (
                ' Sedikit lagi sudah berada di titik akhir, coba perbaiki nilaimu yang masih kurang. '
                'Mungkin akan sedikit terlambat, tapi pelan pelan kamu pasti bisa mencapai titik akhir. '
            ...
            SEMESTER_6_PREDICTION = 'SELAMAT KAMU DIKlasifikasi LULUS TEPAT WAKTU!'
            MOTIVASI = (
                ' Kamu telah melalui lebih dari 20 sks dengan baik. Pertahankan dan tingkatkan kembali nilai-nilai di semester kedepan. '
...
if (selected == 'SEMESTER 7'):
    ...
    if st.button('Klasifikasi Kelulusan'):
        ...
        if SEMESTER_7_prediction[0] == 0:
            SEMESTER_7_PREDICTION = 'KAMU DIKlasifikasi LULUS TIDAK TEPAT WAKTU!'
            MOTIVASI = (
                ' Mungkin akan sedikit terlambat, tapi pelan pelan kamu pasti bisa mencapai titik akhir.'
                '"Mau tidak mau kita harus segera menyelesaikan kuliah agar tidak memberatkan biaya"')
            img3 = Image.open('SYARAT NILAI.jpg')
            ...
            SEMESTER_7_PREDICTION = 'SELAMAT KAMU DIKlasifikasi LULUS TEPAT WAKTU!'
            MOTIVASI = (
